...
public class MAV_BATTERY_STATUS_FLAGS {
   ...
   public static final int MAV_BATTERY_STATUS_FLAGS_CAPACITY_RELATIVE_TO_FULL = 262144; /* 
         ...
         | */
         public static final long MAV_BATTERY_STATUS_FLAGS_EXTENDED = 4294967295L; /* Reserved (not used). If set, this will indicate that an additional status field exists for higher status values. | */
         public static final long MAV_BATTERY_STATUS_FLAGS_ENUM_END = 4294967296L; /*  | */
}
